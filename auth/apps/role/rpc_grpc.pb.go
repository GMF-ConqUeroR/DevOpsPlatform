...
const (
	RPC_CreateRole_FullMethodName = "/devops_platform.role.RPC/CreateRole"
	RPC_QueryRole_FullMethodName  = "/devops_platform.role.RPC/QueryRole"
)
...
func (c *rPCClient) CreateRole(ctx context.Context, in *RoleSpec, opts ...grpc.CallOption) (*Role, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Role)
	err := c.cc.Invoke(ctx, RPC_CreateRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRPCServer) CreateRole(context.Context, *RoleSpec) (*Role, error) {
...
func _RPC_CreateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RPCServer).CreateRole(ctx, req.(*RoleSpec))
	}
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devops_platform.role.RPC",
	...
	Metadata: "auth/apps/role/pb/rpc.proto",
}
